...
This is a supplementary finding and does not affect the headline 2$\times$2 claim. We include it because spike-guard or RHO-Loss-style~\cite{mindermann2022prioritized} filters are increasingly common in practice, and the false-positive-on-clean-data property is, in our experience, easy to miss until one accidentally produces a number that violates expectations.
